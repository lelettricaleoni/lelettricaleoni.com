 ...
 * coordinate inside the box, so `tests/browser/geometry.spec.ts` has no
 * overflow to read (the reason the routes teaser avoids "slice"). The drawing
 * is centred and height-bound; the band is wider than it is tall, so the
 * sides stay plain colour.
 *
  ...
  return (
    <section id="bikes-teaser" className="relative overflow-hidden bg-primary py-20 sm:py-28">
      ...
      >
        ...
        {/* Frame: chainstay, seat tube, seatstay, top tube, down tube, fork */}
